...
public class TabWidgetActivity extends Proxied<TabActivity> {
	  ...
	  //标签切换事件处理，setOnTabChangedListener 
	    mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String tabId) {
				// TODO Auto-generated method stub
				Dialog dialog=new AlertDialog.Builder(TabWidgetActivity.this.asActivity())
				.setTitle("提醒你")
				.setMessage("你当前选中的是"+tabId+"标签！")
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Toast.makeText(TabWidgetActivity.this.asActivity(), "你单击了确定按钮！", Toast.LENGTH_LONG).show();
						dialog.cancel();
					}
				})
				.setNegativeButton("取消", new DialogInterface.OnClickListener() {
					...
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Toast.makeText(TabWidgetActivity.this.asActivity(), "你单击了取消按钮！", Toast.LENGTH_LONG).show();
						dialog.cancel();
					}
				})
				.create();
