...
//下拉框
public class SpinnerActivity extends Proxied<Activity> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		countiesAdapter=new ArrayAdapter<String>(SpinnerActivity.this.asActivity(),android.R.layout.simple_spinner_item,allCounties);
		countiesAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner1.setAdapter(countiesAdapter);
		
		ArrayAdapter adapter=ArrayAdapter.createFromResource(SpinnerActivity.this.asActivity(),R.array.counties,android.R.layout.simple_spinner_item);
