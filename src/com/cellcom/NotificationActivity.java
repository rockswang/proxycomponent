...
//在状态栏中提示
public class NotificationActivity extends Proxied<Activity> {
	...
	private void setWeather(String tickerText,String title,String content,int drawable){
		...
		intent.setClass(this.asActivity(), MainActivity.class);
		PendingIntent pendingIntent=PendingIntent.getActivity(this.asActivity(), 0, intent, 0);
		notification.setLatestEventInfo(this.asActivity(), title, content, pendingIntent);
