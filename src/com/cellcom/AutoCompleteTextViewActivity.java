...
//自动提示框
public class AutoCompleteTextViewActivity extends Proxied<Activity> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter=new ArrayAdapter<String>(AutoCompleteTextViewActivity.this.asActivity(),android.R.layout.simple_dropdown_item_1line,COUNTRIES);
