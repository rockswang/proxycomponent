...
final public class ProxyActivity extends Activity implements Proxied._S_ {
	
	private Proxied<Activity> proxied;
...
//	}
	...
	protected void onCreate(android.os.Bundle a0) {
		proxied = Proxied.createInstance(this, Activity.class);
