...
final public class ProxyTabActivity extends TabActivity implements Proxied._S_ {
	
	private Proxied<TabActivity> proxied;
...
//	}
	...
	protected void onCreate(android.os.Bundle a0) {
		proxied = Proxied.createInstance(this, TabActivity.class);
...
//	}
	...
	public android.app.Activity getCurrentActivity() {
		return proxied != null ? proxied.getCurrentActivity() : super.getCurrentActivity();
	}

//	/** from class android.app.ActivityGroup */
//	public java.util.HashMap onRetainNonConfigurationChildInstances() {
//		return proxied != null ? proxied.onRetainNonConfigurationChildInstances() : super.onRetainNonConfigurationChildInstances();
//	}

	/** from class android.app.TabActivity */
	public android.widget.TabHost getTabHost() {
		return proxied != null ? proxied.getTabHost() : super.getTabHost();
	}

	/** from class android.app.TabActivity */
	public android.widget.TabWidget getTabWidget() {
		return proxied != null ? proxied.getTabWidget() : super.getTabWidget();
	}

	/** from class android.app.TabActivity */
	public void setDefaultTab(int a0) {
		if (proxied != null) proxied.setDefaultTab(a0); else super.setDefaultTab(a0);
	}
...
//			case 3145: super.setPersistent((Boolean) a[1]); break;
			...
			/**** from class android.app.ActivityGroup ****/
			case 4000: return super.getCurrentActivity();
//			case 4002: return super.onRetainNonConfigurationChildInstances();
			/**** from class android.app.TabActivity ****/
			case 5000: return super.getTabHost();
			case 5001: return super.getTabWidget();
			case 5002: super.setDefaultTab((Integer) a[1]); break;
			case 5003: super.setDefaultTab((String) a[1]); break;
			}
		} catch (Throwable ex) {
