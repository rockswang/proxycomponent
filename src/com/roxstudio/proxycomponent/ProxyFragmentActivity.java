...
final public class ProxyFragmentActivity extends FragmentActivity implements Proxied._S_ {
	
	private Proxied<FragmentActivity> proxied;
...
//	}
	...
	protected void onCreate(android.os.Bundle a0) {
		proxied = Proxied.createInstance(this, FragmentActivity.class);
...
//	}
	...
	public Object getLastCustomNonConfigurationInstance() {
		return proxied != null ? proxied.getLastCustomNonConfigurationInstance() : super.getLastCustomNonConfigurationInstance();
	}

	/** from class android.support.v4.app.FragmentActivity */
	public android.support.v4.app.FragmentManager getSupportFragmentManager() {
		return proxied != null ? proxied.getSupportFragmentManager() : super.getSupportFragmentManager();
	}

	/** from class android.support.v4.app.FragmentActivity */
	public android.support.v4.app.LoaderManager getSupportLoaderManager() {
		return proxied != null ? proxied.getSupportLoaderManager() : super.getSupportLoaderManager();
	}
...
//		return proxied != null ? proxied.onPrepareOptionsPanel(a0, a1) : super.onPrepareOptionsPanel(a0, a1);
//	}

	/** from class android.support.v4.app.FragmentActivity */
	protected void onResumeFragments() {
		if (proxied != null) proxied.onResumeFragments(); else super.onResumeFragments();
	}

	/** from class android.support.v4.app.FragmentActivity */
	public Object onRetainCustomNonConfigurationInstance() {
		return proxied != null ? proxied.onRetainCustomNonConfigurationInstance() : super.onRetainCustomNonConfigurationInstance();
	}
	...
	public void supportInvalidateOptionsMenu() {
		if (proxied != null) proxied.supportInvalidateOptionsMenu(); else super.supportInvalidateOptionsMenu();
	}
...
//			case 3145: super.setPersistent((Boolean) a[1]); break;
			...
			/**** from class android.support.v4.app.FragmentActivity ****/
			case 6000: return super.getLastCustomNonConfigurationInstance();
			case 6001: return super.getSupportFragmentManager();
			case 6002: return super.getSupportLoaderManager();
			case 6003: super.onAttachFragment((android.support.v4.app.Fragment) a[1]); break;
//			case 6004: return super.onPrepareOptionsPanel((android.view.View) a[1], (android.view.Menu) a[2]);
			case 6005: super.onResumeFragments(); break;
			case 6006: return super.onRetainCustomNonConfigurationInstance();
			case 6007: super.startActivityFromFragment((android.support.v4.app.Fragment) a[1], (android.content.Intent) a[2], (Integer) a[3]); break;
			case 6008: super.supportInvalidateOptionsMenu(); break;
			}
		} catch (Throwable ex) {
